...
class EnvironmentConfig {
  ...
  loadConfiguration() {
    return {
      ...
      recaptcha: {
        siteKey: this.getEnvVar("VITE_RECAPTCHA_SITE_KEY") || null,
        secretKey: null, // NEVER expose this in frontend - backend only!
      },

      // Security Configuration
      auth: {
        useHttpOnlyCookies: this.getEnvVar("VITE_USE_HTTPONLY_COOKIES") !== "false",
      },
      security: {
        enableCSP: this.getEnvVar("VITE_ENABLE_CSP") !== "false",
        enableCORSProtection: this.getEnvVar("VITE_ENABLE_CORS_PROTECTION") !== "false",
        enableRateLimiting: this.getEnvVar("VITE_ENABLE_RATE_LIMITING") !== "false",
      },
